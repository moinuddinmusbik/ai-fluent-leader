...
- [[2026-07-10-nate-b-jones-daily]] — [[one-minute-agent-test]] FRAMEWORK: 4 estimates (Size, Independence, Separation, Checkability) → 4 verdicts (Chat/Single Agent/Team/Don't Bother); verification wedge + context ceiling as hard limits; 1.6M idle OpenClaw agents; Stanford 15.9%→56%; Anthropic 80% token-spend finding; 40-tool audit paid for itself (FRAMEWORK, 2026-07-10)
- [[one-minute-agent-test]] — Nate's 4-estimate dispatch framework for any AI task; the "Don't Bother" verdict is the one the market never sells; introduced 2026-07-10
